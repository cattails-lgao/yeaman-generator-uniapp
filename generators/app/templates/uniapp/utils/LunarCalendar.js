...
const LunarCalendar = (function() {
	...
	var LunarCalendar = {
		solarToLunar: solarToLunar, // 将公历转换为农历
		lunarToSolar: lunarToSolar, // 将农历转换为公历
		calendar: calendar, // 通过公历获取某月农历数据
		solarCalendar: solarCalendar, // 获取公历某月日历数据（不带农历信息）
		setWorktime: setWorktime, // 设置某年的节假日安排信息（类库已内置2013-2014年的数据）
